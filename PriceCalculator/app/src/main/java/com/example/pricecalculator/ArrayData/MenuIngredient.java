...
public class MenuIngredient {
    ...
    public MenuIngredient(String menu_ingredient_name, int ingredient_id, int menu_ingredient_weight, String menu_ingredient_unit, double menu_ingredient_price) {
